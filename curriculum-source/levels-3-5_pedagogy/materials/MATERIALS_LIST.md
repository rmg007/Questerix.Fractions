...
This list covers ALL materials needed for a full Grade 1 year of fraction instruction (34 weeks).

**Total preparation time:** approx 10-15 hours across the year (most in August/September before Week 1).

**Total cost estimate:** $150-300 per classroom (one-time purchases + annual consumables). Most materials are reusable year over year.
...
- **Chart paper** (large display): 1 pad
...
- **Ribbons** (6", 12", 18" lengths in colors): 15 of each length
- **Paper fish** (for Week 4 Equal Lake): 30
- **Paper leaves** (various shapes, for Week 4 Fold Forest): 30
- **Paper "pizza toppings"** (crayon is adequate, but stickers optional)
...
- **Blocks** (small, for set halving): 100
- **Play-dough** (6 colors): 1 large tub
- **Child-safe scissors**: 1 per child (class set)
...
- **Puppets or plushies** (handmade or purchased):
  ...
  - Crumb
  - Optional: others
- **Queen Equallia props:**
  - Crown (paper or costume)
  - Sash (half silver, half gold)
  - Pitcher for "truth-water" (any clear jug)
  - Truth-water (safe glitter water or colored water)
- **Lord Notenough prop:** Dark cloak (for teacher brief appearance)
...
## CATEGORY 4 — WRITING AND ART SUPPLIES

- **Crayons** (24-pack): 1 per child
- **Markers** (washable): 1 class set
- **Pencils**: class supply
- **Erasers**: class supply
- **Glue sticks**: 30
- **Tape** (various): assorted
- **Stickers** (celebration): 200+

---

## CATEGORY 5 — ASSESSMENT AND PORTFOLIO MATERIALS

- **Binders or pocket folders** (for Year Portfolios): 1 per child
- **Divider tabs** (3 phases): 1 set per child
- **Assessment sheet printouts** (from curriculum): class sets
- **Badges and certificates** (printable):
  - Equal Detective Badge
  - Halver Certificate
  - Kingdom Badges (5 per child for Week 4)
  - Halver Mastery Certificate
  - Halver & Fourther Badge
  - Junior Detective Certificate
  - Kingdom Detective Certificate
  - Reunification Specialist Certificate
...
- Parent invitations
- Year Portfolios fully assembled
- Final celebration snacks (with dietary care)
...
## CATEGORY 8 — FOOD FOR ACTIVITIES (OPTIONAL, WITH CAUTION)
...
**Never exclude a child from the ACTIVITY because of dietary needs.** Paper alternatives always.
...
- Anchor charts: hand-lettered

---

## ANNUAL CONSUMABLES

These need to be restocked each year:

- Construction paper (~$20)
- Cardstock (~$15)
- Crayons (~$25)
- Glue sticks (~$15)
- Certificate cardstock (~$10)
- Stickers (~$10)
- Play-dough (~$20)
- Printer ink (~$30)
...
## DURABLE (MULTI-YEAR) PURCHASES

One-time investments:

- Magnetic fraction pieces (~$40)
- Foam circles and shapes (~$30)
- Character plushes (~$50 for 3)
- Balance scales (~$30)
- Queen Equallia crown (~$10)
- Cardboard Whole Hearth (~$20)
- Kingdom Map posters (~$40)
...
Create labeled bins or boxes for:

- **Bin 1:** Week 1-6 materials (Discovery phase)
- **Bin 2:** Week 7-20 materials (Formalization phase)
- **Bin 3:** Week 21-32 materials (Transfer phase)
- **Bin 4:** Special event materials (ceremonies)
- **Bin 5:** Portfolio supplies (binders, labels)
- **Bin 6:** Character and narrative materials
- **Bin 7:** Assessment materials (paper sheets, rubrics)

Store somewhere accessible between years.
...
- Grants for equity-related materials (bilingual supports, adaptive tools)

---

## SUSTAINABILITY NOTES

- Reuse paper circles after activities (save for next year's demo)
- Laminate key pieces for reuse
- Use recycled paper where possible
- Consider compostable materials for feast day
