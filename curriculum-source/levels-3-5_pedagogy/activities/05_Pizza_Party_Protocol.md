...
**Goal:** Consolidate halving fluency in a socially rich "pizza party" context while beginning the transition to FOURTHS via a halve-the-halves move.
...
**Purpose:** Fluency practice — halve multiple pizzas quickly with accuracy.

**The Rapid Halving Challenge:**
Each child receives 4 paper pizzas. They halve each one, checking equality each time. Timer is NOT used (no time pressure per Grade 1 pedagogy), but children who finish demonstrate fluency.

**Gallery Share:** Children display all 8 halves and discuss.

---

### DAY 3 — THE FOUR-FRIEND PROBLEM
...
**Story (15 min):**
At the party, Pia has ONE pizza. Four people want to eat: Halfie, Halvo, Pia herself, and the child. Pia halves. Now Halfie can eat one half and Halvo another — but what about Pia and the child?
...
**Activity:**
Children fold each shape into halves, then fold again to make fourths. They record the two-fold process: "Fold once = 2 halves. Fold twice = 4 fourths."
...
### DAY 5 — THE PIZZA PARTY AND ASSESSMENT
...
**The Party (20 min):**
Class holds a pretend (or real) pizza party. Students practice halving and fourthing with real social stakes. Each child serves pieces to "guests" (stuffed animals or classmates).
...
- **ELLs:** Vocabulary cards "fourth, quarter, four equal parts"
- **Motor:** Pre-folded pizzas; teacher cuts
- **Advanced:** "What if 8 friends came? How many pieces?" (halve twice more)
- **Struggling:** Focus on halving; introduce fourths in Week 6
...
- Invitations (Day 1)
- Halving samples (Day 2)
- First fourths (Day 3)
- Fold Journal (Day 4)
- Assessment Sheet (Day 5)
