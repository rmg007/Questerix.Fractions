...
**Goal:** Develop explicit compositional reasoning — the understanding that fractions can be COMBINED to recover the whole, and that fractions have PART-WHOLE relationships.
...
- **F14:** Decompose a whole into halves or fourths; reassemble
...
### WEEK 26 — REUNIFICATION FOUNDATIONS

### Day 1 — Meet the Reunification Mission
...
- Reunification Journal

**Story (10 min):**
Lord Notenough has scattered pieces. Pia finds a pile: two halves of a pizza. She places them together — they MATCH and form a WHOLE. She does the same with four fourths of a pie.
...
Record in Reunification Journal with drawings and labels.

**Closure (5 min):**
Class chants: "Two halves, one whole! Four fourths, one whole! Two fourths, one HALF!"
...
**Recording:**
"I started with 1 whole. I made 2 halves. I made 4 fourths. I rebuilt 2 halves. I rebuilt 1 whole."

This bidirectional work (decompose ↔ recompose) is the essence of compositional reasoning.

### Day 3 — Mixed Pieces (Detective Work)
...
**Challenge:**
Pieces have been scattered from multiple wholes. Children must SORT pieces back to their original wholes, then reassemble each.

This is a **matching** task that requires careful attention to size, shape, and identifying which pieces "belong."

**Key Insight:**
Pieces only reassemble when they came from the SAME whole. Halves of different pizzas don't match. This reinforces the whole-referent principle.

### Day 4 — Building a Whole from Mixed Pieces
...
This is a BIG conceptual moment. Treat it with ceremony.

### Day 5 — Weekly Reunification Certificate

**Duration:** 40 min

**Activity:**
Each child assembles a "demonstration whole" using any combination of halves and fourths. They must explain (in words or drawing) how their pieces equal a whole.

**Ceremony:**
Teacher "certifies" each child as a **Reunification Specialist**. Class claps.

---

### WEEK 27 — REUNIFICATION MASTERY

Building on Week 26, Week 27 extends:

**Day 1:** Reunification across different shape types (square pieces, rectangle pieces)
**Day 2:** Reunification of sets (4 groups of counters = 1 whole set)
**Day 3:** Ribbon reunification (length)
**Day 4:** Mixed-context challenge day
**Day 5:** Phase 3 Midpoint Assessment

---

## KEY COMPOSITIONAL FACTS (GRADE 1 ANCHOR CHART)

Posted in classroom:

```
🥧 THE KINGDOM'S FRACTION LAWS 🥧
...
These four statements are the **durable residue** of Grade 1. Children should be able to state them from memory by Week 28.
...
By end of Week 27, Pia has helped reunify the kingdom. Lord Notenough's scattered pieces are back together. But the Hunger Storm is getting closer. The climax (Weeks 29-31) approaches.

Children feel triumphant: they have mastered the deepest Grade 1 concept.

---

## ASSESSMENT DATA

- Reunification Journals (2 weeks of work)
- Mixed-piece sorting accuracy
- Compositional statements (verbal and written)
- Phase 3 Midpoint Assessment (Week 27 Day 5)
