...
**Goal:** Provide an extended, immersive practice week where children apply halving in many contexts through a story-driven "adventure" across the Halving Kingdom.

**Why This Activity:**
One week of halving instruction (Activity 03) is not enough for durable mastery. Children need to halve many things, in many contexts, with many levels of support, before halving becomes automatic. This week is that practice — but the practice is disguised as an ADVENTURE. Children don't feel like they're practicing; they feel like they're saving the kingdom.
...
- **F4:** Recognize halves even in unusual orientations.

**Meta-Objective:**
Build FLUENCY and CONFIDENCE with halving before Fourths are introduced in Week 5-6.

---

## THE ADVENTURE FRAMING

Children receive an "Adventure Journal" at the start of the week. Each day they journey to a different region of the Halving Kingdom and face a halving challenge. At week's end, they have explored five regions and completed five quests. Each quest earns a "Kingdom Badge."

This is **gamification with integrity** — the adventure arises from the story, not from artificial point systems.

### The Five Regions

1. **Monday — The Whole Hearth (starting point)** — Halving pizzas with Whola
2. **Tuesday — The Ribbon Road** — Halving ribbons on a journey
3. **Wednesday — The Equal Lake** — Halving fish and groups of lake creatures
4. **Thursday — The Fold Forest** — Halving trees and leaves through folding
5. **Friday — The Halving Hills (destination)** — Final ceremony with Halfie and Halvo

---

## FIVE-DAY PLAN

### DAY 1 — THE WHOLE HEARTH QUEST
...
- Crayons
- Pizza plates
- Monday's Adventure Read-Aloud: "Pia Begins Her Journey"
...
Whola gives Pia three pizzas of different sizes and asks her to prove she can halve each one BEFORE leaving the Hearth.

**The Three-Pizza Quest (25 min):**

Each child receives 3 pizzas (small, medium, large). They must:

1. Halve each pizza (fold, trace line, cut).
2. Place halves on plates.
3. Check each halving with the "Equal Detector" station (mirror + Queen Equallia's water image).
4. Record all 3 halvings in the Adventure Journal:
   - Trace the pizza shape.
   - Draw the halving line.
   - Write (or dictate): "I halved the [size] pizza."
...
This plants the seed for the later insight: "1/2 of a small pizza ≠ 1/2 of a large pizza in AMOUNT, but both ARE halves."
...
**The Ribbon Challenge (25 min):**

Each child receives 3 ribbons of different lengths. For each ribbon:

1. Fold the ribbon in half (endpoint to endpoint).
2. Mark the fold with a piece of tape or sticker.
3. Cut at the fold.
4. Compare the two halves side by side (Equal Detector!).
5. Record in Adventure Journal: draw the ribbon, mark where they cut, note any challenge.
...
This reinforces Day 1's lesson in a new context.
...
**The Set-Halving Quest (30 min):**

Children work in pairs. Each pair receives a "Lake" with a varying number of fish (e.g., 4, 6, 8, or 10). Their task:

1. Divide the fish into TWO EQUAL GROUPS (half for each of two lake creatures).
2. Count each group to verify equality.
3. Record in Adventure Journal: "We had [X] fish. We made [X/2] and [X/2]."

**The Odd-Number Challenge:**
...
Teacher validates: "Smart thinking. Sometimes when a set is odd, we have to do something special to make it even. We'll learn more about this next week."

(This plants a critical seed for understanding that halving SETS requires evenness.)
...
**The Folding Challenge (30 min):**

Children work at tables with piles of paper leaves and shapes. They must:

1. Fold each shape in half (find the line of symmetry).
2. Trace the fold line with a crayon.
3. Sort shapes into two piles:
   - "Easy to halve" (symmetric shapes)
   - "Tricky to halve" (irregular shapes)
...
### DAY 5 — THE HALVING HILLS QUEST AND COMPLETION CEREMONY
...
- Fraction Fairy visit materials (sparkle wand, glitter-free sparkle dust)
- Halver Mastery Certificate (more elaborate than Week 3)
- Adventure Journal
...
Each child receives a special pizza (or works in pairs). They must:

1. Identify the whole.
2. Find the halving line (fold or visualize).
3. Halve the pizza (fold, cut).
4. Verify equality.
...
This week is where the narrative BECOMES the curriculum. Children travel through the kingdom as Pia's helpers. By Friday, Pia (and the child) have:

- Traveled through 5 regions
- Solved 5 kingdom problems
- Earned 5 badges
- Been celebrated by the Fraction Fairy

The **emotional stakes** are high. Children feel they have DONE SOMETHING, not merely LEARNED something.

---

## ASSESSMENT DATA TO COLLECT

1. **Adventure Journals:** Complete record of each quest's work
2. **Badge Inventory:** Who earned each badge?
3. **Observational Rubric:** Teacher notes on each child's fluency at each station
4. **Final Pizza Task:** Photograph each child's final halving
5. **Halver Mastery Certificate:** Issued or held?

**Children missing 2+ badges:** Plan small-group re-teach in Week 5-6.

---

## RESEARCH JUSTIFICATION

This extended application week is supported by:

1. **Distributed practice** (Dunlosky et al., 2013): Spacing halving across 5 days vs. 1 day improves retention.
2. **Interleaving** (Rohrer, 2012): Different contexts (pizza, ribbon, set, fold) for the same concept deepens understanding.
3. **Story-embedded learning** (Willingham, 2009): Narrative containers make practice engaging and memorable.
4. **Gamified mastery** (Deci & Ryan, 1985): Badges as intrinsic celebration, not extrinsic reward.
...
- [ ] Prepare special Day 5 pizza
- [ ] Print Halver Mastery Certificates
- [ ] Prepare Fraction Fairy costume/role
...
Week 5 (Pizza Party Protocol): Extend halving to community settings and begin introducing FOURTHS as halving twice.

By end of Week 4, children have **fluent halving**. They are ready for the compositional move to fourths.
