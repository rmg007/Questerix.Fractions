...
- **Embodied cognition:** The body is the first manipulative (Lakoff & Núñez, 2000).
- **Bilateral symmetry:** All vertebrate bodies are halved; this is pre-mathematical intuition.
- **Narrative integration:** Halfie and Halvo arrive this week. Children become them.
- **Visual-motor linkage:** Children learn halving as a MOTION (the fold gesture, the cut gesture, the symmetry-line gesture).

---

## FIVE-DAY PLAN

### DAY 1 — MEET HALFIE AND HALVO
...
- Large floor space
- Optional: costume accessories (half-blue, half-yellow paper vests for children to wear)
...
Summary: Pia bakes ONE pizza. Halfie and Halvo arrive, both hungry. Pia says, "You can have it!" but realizes she has ONE pizza for TWO friends. She panics. Halfie and Halvo hold hands: "We always get the SAME amount. That's our rule." Pia must figure out how.

The story ends BEFORE the answer. Children will discover the answer through this week's activities.

**Body Activity: Meet Yourself as a Halver (25 min):**
...
- 2 plush "Halfie" and "Halvo" figures per classroom (or hand-drawn puppets)
- Camera (teacher documentation)
...
3. Presses the fold.
4. Opens and traces the fold line.
5. With teacher supervision, cuts ALONG the fold line (if fine motor allows) or the teacher cuts.
6. Places one half on a plate for "Halfie" and one half on a plate for "Halvo."
...
### DAY 4 — HALVING ALL KINDS OF WHOLES
...
- Stations set up around the room:
  ...
  - **Station 3:** Strings/ribbons ("halve the ribbon")
  - **Station 4:** Piles of 6 blocks each ("halve the blocks into two equal groups")
  - **Station 5:** Drawn shapes on paper, kids draw the fold line
...
4. Record their work on a Station Passport.

**Station 1 — Sandwich Rectangles:**
Fold a paper rectangle into halves. Note: rectangles can be halved vertically, horizontally, or diagonally. Encourage exploration.

**Station 2 — Play-Dough Halving:**
Roll a ball of dough. Use a plastic knife to cut into two equal pieces. Use a balance scale to verify equality (scale provided at station).

**Station 3 — Ribbon Halving:**
Given a 12-inch ribbon, fold it in half and mark the midpoint. Cut or mark with a sticker. Check that both halves are the same length.

**Station 4 — Set Halving:**
Given 6 blocks, split into two equal groups. Children discover: 3 and 3. What about 8 blocks? 4 and 4. What about 5? Uh-oh — you can't halve 5 evenly with blocks alone! (Teacher notes this for later discussions about odd vs. even.)

**Station 5 — Fold Line Drawing:**
Given printed shapes on paper, draw the fold line that would make halves. No folding needed — just visualizing.
...
### DAY 5 — HALVING MASTERY AND CELEBRATION
...
- Optional: Queen Equallia cutout or image
...
Each child receives an Assessment Sheet with the following tasks:

**Part 1: Fold and Check.** Child is given a paper square. Folds it into halves. Teacher checks for: edges match, fold is firm, halves are equal.

**Part 2: Cut and Share.** Child is given a paper circle. Cuts into two pieces for Halfie and Halvo. Teacher checks: are the pieces equal?

**Part 3: Identify Halves.** Worksheet with 6 shapes; 3 are halved correctly, 3 are not. Child circles the correct ones.
...
- Provide a "half template" (a shape with a fold line already drawn) as scaffolding
...
- Queen Equallia has validated their first halving.

They are no longer audience. They are participants in the kingdom.
...
- [ ] Print Halving Assessment sheets
- [ ] Print Halver Certificates
- [ ] Prepare large "Kingdom Pie" for Day 5 ceremony
- [ ] Prepare Halfie and Halvo puppets/plushes (even crude cutouts work)
- [ ] Queue "Pia's First Halving" read-aloud script

---

## ASSESSMENT DATA TO COLLECT

1. **Fold Journals:** 5 folded/traced shapes per child
2. **Pizza Halving (Day 3):** Photograph each child's two plates
3. **Station Passport (Day 4):** Stamped record of 5 stations
4. **Assessment Sheet (Day 5):** Individual mastery data
5. **Conference quotes:** Children's explanations of "half"

---

## CONNECTION TO NEXT WEEKS

Week 4 (The Halving Adventure): A full-day kingdom journey applying halving skills in story-driven tasks.
...
These are the three foundational skills. The rest of the year builds on them.

---

## RESEARCH JUSTIFICATION

This week combines four research-based moves:

1. **Embodied before symbolic** (Lakoff & Núñez, 2000): Body → paper → language → (later) symbol.
2. **Folding before cutting** (Tzur & Hunt, 2015): Folding makes equal-ness visible and reversible; cutting makes mistakes permanent.
3. **Narrative integration** (Willingham, 2009): The Halfie/Halvo story gives a "reason" for halving.
4. **Assessment as ceremony** (Wiggins & McTighe, 2005): Formative assessment embedded in meaningful ritual increases engagement.
