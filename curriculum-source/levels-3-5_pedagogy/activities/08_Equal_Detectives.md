...
**Goal:** Develop fluent, accurate vocabulary for halves, fourths, and fraction recognition in the world — without introducing symbolic notation.

**Why This Activity Cluster:**
After Weeks 7-9 (folding fluency), children can DO halving and fourthing. Week 10 provides intensive fourths practice (see pacing guide). Weeks 11-14 are the **vocabulary and recognition** block, where children learn:

- The words: "half," "halves," "fourth," "fourths," "quarter," "quarters"
...
### WEEK 11 — Detective Academy Opens
...
- Th: Integrate — use all words in extended sentences
- F: Weekly Detective Test (game-like)

### WEEK 12 — Recognition in Pictures
...
- Chocolate bars
- Shapes in coloring books

Children shout: "That's a HALF!" or "That's a FOURTH!"

**Key Skill:** Recognition under **perceptual variation** — rotated halves, different colors, different backgrounds.

### WEEK 13 — Recognition in the Classroom
...
- Windows (panes = fourths?)
- Floor tiles
- Books (pages as halves of a whole book?)

Children create "Kingdom Fraction Maps" of their school.

### WEEK 14 — Mixed Mastery and Queen's Mid-Year Review

**Daily Focus:**
M-Th: Mixed practice with all vocabulary, all contexts
...
4. Previews the challenges of Weeks 15-20.
...
## SAMPLE DETAILED DAY — WEEK 12 DAY 2
...
- 30 picture cards showing various halving examples:
  ...
  - 10 RED HERRINGS (fourths that kids might mistakenly call halves)
- Detective badges
- "Real Half" and "Not a Half" sorting mats

**Opening (5 min):**
Detective Chant. Review "half means TWO EQUAL PARTS of a WHOLE."
...
**Share (10 min):**
Pairs share 2-3 interesting cards. Class discusses disagreements.

**Closure (5 min):**
Every child says a sentence with "half" — e.g., "A pizza cut into two equal pieces has halves."
...
These error-spotting tasks build metalinguistic awareness.

---

## ASSESSMENT DATA

- **Vocabulary Inventory** at end of each week (checklist: can child use each word correctly?)
- **Sort Accuracy** across weeks 12-14
- **Kingdom Fraction Maps** (Week 13 artifact)
- **Queen's Mid-Year Review** (Week 14 Friday): summative assessment
