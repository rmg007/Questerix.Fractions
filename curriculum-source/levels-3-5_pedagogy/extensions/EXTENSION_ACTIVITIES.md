...
Extensions in this curriculum are:

- **DEEP, not ACCELERATED.** We don't push children to Grade 2 content early.
- **OPTIONAL, not required.** Children who don't complete them are not "behind."
- **PLAYFUL, not pressure.** Extensions should feel like games, not homework.
- **CONCEPTUAL, not procedural.** They deepen understanding, not skill repetition.
...
## EXTENSION ACTIVITIES LIST

### E1 — THE MANY HALVES CHALLENGE

**When:** After Week 3 (Body Math Halves)
...
- Other diagonal → 2 triangles

Four ways! Children draw all four on a mat.

**Extension:**
"What about a circle?" (Infinitely many — through any diameter)
"What about a rectangle?" (Four ways, same as square)

**Learning goal:** Generalize halving beyond one method.

---

### E2 — THE IRREGULAR SHAPE CHALLENGE

**When:** After Week 4 (Halving Adventure)
...
**Learning goal:** Halving is a concept, not tied to symmetrical shapes.

---

### E3 — THIRDS INTRODUCTION (SNEAK PREVIEW)

**When:** After Week 6 (Fourths Festival)
...
**Learning goal:** The fraction family has more members than halves and fourths.

---

### E4 — THE GREAT FRACTION FAMILY

**When:** After Week 10 (Fourths deep practice)
...
**Activity:**
Make a "Fraction Family Tree" showing how fractions relate.

**Learning goal:** See the compositional structure of the entire family.

---

### E5 — DESIGN YOUR OWN CRUMB MISTAKE

**When:** Any time Phase 2 onward
...
**Extension:** Pair with peer who must identify and correct the mistake.

**Learning goal:** Meta-cognition — thinking about wrong thinking.

---

### E6 — THE STORY PROBLEM WRITING PROJECT

**When:** After Weeks 21-22 (Story Solver introduction)
...
**Extension:** Classmates solve each other's problems.

**Learning goal:** Problem structure understanding.

---

### E7 — THE COMPOSITIONAL PUZZLE

**When:** After Week 27 (Build a Whole)
...
**Learning goal:** Flexible decomposition / composition.
...
**Learning goal:** Aesthetic engagement; visual-spatial reasoning.

---

### E9 — FRACTIONS IN MUSIC

**When:** Any time after Phase 1

**Activity:**
"Let's sing 'Twinkle Twinkle Little Star.' Now sing only the FIRST HALF."
...
**Learning goal:** Fractions exist in time-based media too.

---

### E10 — FRACTIONS IN THEIR BODY

**When:** Any time Phase 1

**Activity:**
"Your body is ONE WHOLE. What are the halves?" (Top/bottom? Left/right? Front/back?)

"What are the fourths?" (Top-left, top-right, bottom-left, bottom-right quarters)

Children draw a self-portrait with halves and fourths labeled.

**Learning goal:** Embodied, personal understanding.

---

### E11 — FRACTIONS OF THE KINGDOM MAP
...
**Learning goal:** Apply fraction thinking to an abstract map.

---

### E12 — FRACTIONS IN TIME, DEEP DIVE
...
**Learning goal:** Temporal proportional reasoning.

---

### E13 — THE HALVING DIALECTIC (Advanced Thinking)

**When:** Late year, for advanced students
...
- Halve the eighth (= sixteenth)

Eventually, they realize you could keep going forever (in theory — in practice, scissors have limits).

**This is philosophical/mathematical depth.** Introduces the concept of infinity.

**Learning goal:** Conceptual exploration beyond grade level.
...
## EXTENSIONS AS WHOLE-CLASS LESSONS

Some extensions work well as whole-class lessons on special days:

- **E1** (Many Halves) — great for a rainy indoor day
- **E3** (Thirds Preview) — after a particularly successful week
- **E8** (Fractions in Art) — integrates with art class
- **E9** (Fractions in Music) — integrates with music class

---

## HOME EXTENSIONS

Extensions can go home as optional family activities. The parent companion (`parent/PARENT_COMPANION.md`) mentions:

- Halve and fourth real food together
- Find fractions at home
- Tell Pia stories
...
## RESEARCH ON EXTENSIONS

- **Tomlinson (2014)** — Differentiation by depth, not just speed
- **Renzulli (2012)** — Enrichment Triad Model
- **Subotnik et al. (2011)** — Rethinking giftedness

Extensions support BOTH gifted development and general curiosity-driven learning.
...
Extensions should ADD to the year, not poison it.
