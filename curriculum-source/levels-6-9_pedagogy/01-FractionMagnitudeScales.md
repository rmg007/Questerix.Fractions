 ...
 */
function snapPositionToDecimal(
  snapX: number,
  lineStartX: number,
  lineEndX: number
): number {
...
function evaluateAdvancement(perf: SessionPerformance, currentScaffold: number): 'advance' | 'stay' | 'regress' {
  // Advance criteria
