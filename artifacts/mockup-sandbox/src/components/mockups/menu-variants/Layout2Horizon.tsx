  ...
  return (
    <div className="w-[420px] h-[780px] flex flex-col relative overflow-hidden bg-[#4ADE80] font-['Nunito']">
      ...
      <div className="h-[40%] bg-[#38BDF8] relative flex flex-col items-center pt-12 z-10">
        {/* Sun */}
        <svg className="absolute top-6 left-6 w-20 h-20 animate-[spin_10s_linear_infinite]" viewBox="0 0 100 100">
          <circle cx="50" cy="50" r="20" fill="#FCD34D" />
          <path d="M50 10 L50 20 M50 80 L50 90 M10 50 L20 50 M80 50 L90 50 M22 22 L29 29 M71 71 L78 78 M22 78 L29 71 M71 29 L78 22" stroke="#FCD34D" strokeWidth="6" strokeLinecap="round" />
        </svg>
        ...
        <div className="z-20 flex flex-col items-center">
          <h1 className="font-['Fredoka_One'] text-5xl text-white text-center leading-tight drop-shadow-[0_4px_4px_rgba(0,0,0,0.25)] stroke-black stroke-2" style={{ WebkitTextStroke: '2px #1E3A8A' }}>
      ...
      <div className="relative w-full h-16 z-20">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-30 animate-float">
          <svg width="180" height="180" viewBox="0 0 200 200">
            ...
            {/* Split dashed line */}
            <line x1="100" y1="10" x2="100" y2="190" stroke="#B45309" strokeWidth="6" strokeDasharray="10 10" />
            
            {/* Eyes */}
            <ellipse cx="65" cy="75" rx="15" ry="25" fill="white" stroke="#B45309" strokeWidth="4" />
            <ellipse cx="135" cy="75" rx="15" ry="25" fill="white" stroke="#B45309" strokeWidth="4" />
      ...
      <div className="flex-1 bg-[#4ADE80] z-10 flex flex-col items-center justify-end pb-12 px-8 pt-16">
        ...
        <div className="absolute bottom-0 left-0 w-full flex justify-between px-4 pointer-events-none opacity-60">
          <svg width="40" height="30" viewBox="0 0 40 30" fill="none" stroke="#16A34A" strokeWidth="3" strokeLinecap="round">
            <path d="M20 30 L20 10 M20 30 L10 15 M20 30 L30 18" />
          </svg>
          <svg width="50" height="40" viewBox="0 0 50 40" fill="none" stroke="#16A34A" strokeWidth="3" strokeLinecap="round">
            <path d="M25 40 L25 15 M25 40 L10 20 M25 40 L40 25 M25 40 L15 10" />
          </svg>
          <svg width="35" height="25" viewBox="0 0 35 25" fill="none" stroke="#16A34A" strokeWidth="3" strokeLinecap="round">
