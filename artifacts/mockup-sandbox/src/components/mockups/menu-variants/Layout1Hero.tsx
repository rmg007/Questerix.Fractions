    ...
    <div className="relative w-full max-w-[420px] mx-auto h-[780px] bg-[#38BDF8] overflow-hidden flex flex-col items-center justify-between shadow-2xl font-['Nunito'] border-4 border-slate-900 rounded-[32px]">
      ...
      <div className="absolute top-4 left-4 opacity-80">
        <svg width="48" height="32" viewBox="0 0 48 32" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M12 16C12 9.37258 17.3726 4 24 4C28.8475 4 33.0232 6.87326 34.9392 11.0827C35.6322 11.0284 36.3402 11 37.0588 11C42.548 11 47 15.4772 47 21C47 26.5228 42.548 31 37.0588 31H12C5.37258 31 0 25.6274 0 19C0 12.3726 5.37258 7 12 7V16Z" fill="white"/>
        </svg>
      </div>
      ...
      <div className="absolute top-8 right-6 opacity-90 animate-[spin_10s_linear_infinite]">
        <svg width="60" height="60" viewBox="0 0 60 60" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M51.2132 8.7868L44.1421 15.8579L41.3137 13.0294L48.3848 5.95837L51.2132 8.7868Z" fill="#FCD34D"/>
          <path d="M8.7868 51.2132L15.8579 44.1421L13.0294 41.3137L5.95837 48.3848L8.7868 51.2132Z" fill="#FCD34D"/>
          <path d="M51.2132 51.2132L48.3848 54.0416L41.3137 46.9706L44.1421 44.1421L51.2132 51.2132Z" fill="#FCD34D"/>
          <path d="M8.7868 8.7868L5.95837 11.6152L13.0294 18.6863L15.8579 15.8579L8.7868 8.7868Z" fill="#FCD34D"/>
        </svg>
      </div>
      ...
      <div className="relative mt-20 z-10 w-full flex justify-center animate-[float_4s_ease-in-out_infinite]">
        <svg width="280" height="280" viewBox="0 0 240 240" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-2xl">
          {/* Main Body */}
          <circle cx="120" cy="120" r="110" fill="#FCD34D" stroke="#78350F" strokeWidth="8"/>
          
          {/* Dashed line for fraction */}
          <line x1="120" y1="10" x2="120" y2="230" stroke="#78350F" strokeWidth="6" strokeDasharray="12 12"/>
          ...
          {/* Smile */}
          <path d="M60 140 C 60 190, 180 190, 180 140 Z" fill="white" stroke="#78350F" strokeWidth="6"/>
      ...
      <div className="w-full px-8 pb-10 mt-auto flex flex-col gap-3 relative z-10">
        <Button 
          className="w-full h-14 bg-[#F59E0B] hover:bg-[#D97706] text-white text-2xl font-['Fredoka_One'] rounded-2xl border-b-4 border-[#B45309] shadow-lg active:translate-y-1 active:border-b-0 transition-all animate-[pulse-bounce_2s_ease-in-out_infinite]"
        >
        ...
        <Button 
          className="w-full h-14 bg-[#38BDF8] hover:bg-[#0EA5E9] text-white text-xl font-bold rounded-2xl border-b-4 border-[#0284C7] shadow-md active:translate-y-1 active:border-b-0 transition-all"
        >
        ...
        <Button 
          className="w-full h-14 bg-white hover:bg-slate-50 text-[#0F172A] text-xl font-bold rounded-2xl border-b-4 border-slate-200 shadow-sm active:translate-y-1 active:border-b-0 transition-all"
        >
