  ...
  return (
    <div className="w-[420px] h-[780px] bg-[#FFF8E7] flex items-center justify-center relative overflow-hidden font-['Nunito']">
      ...
      <div className="absolute inset-0 pointer-events-none opacity-20">
        <div className="absolute top-10 left-10 text-4xl font-black text-orange-400 rotate-12">
          ½
        </div>
        <div className="absolute bottom-20 right-10 text-5xl font-black text-blue-400 -rotate-12">
          ⅓
        </div>
        <div className="absolute top-40 right-12 text-3xl font-black text-green-400 rotate-45">
          ¼
        </div>
        <div className="absolute bottom-40 left-8 text-4xl font-black text-purple-400 -rotate-12">
          ⅛
        </div>
      </div>
          ...
          <g className="slice slice-play">
            ...
            <foreignObject x="80" y="230" width="240" height="100">
              <div className="w-full h-full flex flex-col items-center justify-center text-white pointer-events-none">
                ...
                <span className="font-['Fredoka_One'] text-4xl stroke-black drop-shadow-[0_2px_0_#000]">
                  Play!
                </span>
                <span className="font-black text-lg bg-black/20 px-3 py-0.5 rounded-full mt-1">
                  ½
                </span>
              </div>
            </foreignObject>
          ...
          <g className="slice slice-continue">
            ...
            <foreignObject x="40" y="60" width="140" height="120">
              <div className="w-full h-full flex flex-col items-center justify-center text-white pointer-events-none -rotate-12">
                ...
                <span className="font-['Fredoka_One'] text-2xl drop-shadow-[0_2px_0_#000]">
                  Continue
                </span>
                <span className="font-black text-sm bg-black/20 px-2 py-0.5 rounded-full mt-1">
                  ⅓
                </span>
              </div>
            </foreignObject>
          ...
          <g className="slice slice-settings">
            ...
            <foreignObject x="240" y="80" width="120" height="100">
              <div className="w-full h-full flex flex-col items-center justify-center text-white pointer-events-none rotate-12">
                ...
                <span className="font-['Fredoka_One'] text-xl drop-shadow-[0_2px_0_#000]">
                  Settings
                </span>
                <span className="font-black text-xs bg-black/20 px-2 py-0.5 rounded-full mt-1">
                  ⅙
                </span>
              </div>
            </foreignObject>
