    ...
    steps:
      ...
      - name: Regenerate workflows and check for drift
        run: |
          ...
          git diff --exit-code .github/workflows/ci.yml .github/workflows/synthetic-playtest.yml || (echo "ERROR: Workflow drift detected. Run 'npm run gen:workflows' and commit the result." && exit 1)
