...
| **Grade level** | Grade 2 |
| **Related skills** | `SK-24`, `SK-25` |
| **Source** | Observed; not in M1–M12 but documented in Behr et al. (1983) |

---

### 3.5 Shape and Vocabulary Family (MC-SHP-*, MC-VOC-*)
...
Detection signals above describe *patterns*, not single attempts. Implementation guidance:
