...
This document is informational only. Per **C2** (no teacher surface) the student never sees standards. Per **C10** (validation is the goal) standards alignment is a _secondary_ concern — the primary measure is whether the mechanic teaches.
