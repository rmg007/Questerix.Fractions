/**
 * Barrel export for all Interaction implementations.
 */

export type { Interaction, InteractionContext } from './types';
export { PartitionInteraction } from './PartitionInteraction';
export { IdentifyInteraction } from './IdentifyInteraction';
export { LabelInteraction } from './LabelInteraction';
