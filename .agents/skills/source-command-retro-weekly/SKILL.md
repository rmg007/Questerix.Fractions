---
name: "source-command-retro-weekly"
description: "Weekly token-cost rollup — group _session-log.md by day, print percentiles, flag outliers"
---

# source-command-retro-weekly

Use this skill when the user asks to run the migrated source command `retro-weekly`.

## Command Template

Read `.Codex/_session-log.md`, group entries by date, report token-usage patterns over 7 days. **Read-only.**

## Steps

1. `tail -200 .Codex/_session-log.md` — last ~7 days of pre-compact lines.
