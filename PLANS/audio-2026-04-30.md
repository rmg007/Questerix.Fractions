...
**Sibling plans:** [ux-elevation-2026-04-30.md](./ux-elevation-2026-04-30.md) (references "the audio plan" repeatedly), [harden-and-polish-2026-04-30.md](./harden-and-polish-2026-04-30.md) (TTS hardening — Phase 3.3).
...
### Pipeline
```
src/lib/quest/copy.ts (manifest, single source of truth — already proposed in ux-elevation-2026-04-30.md T2)
                ↓
npm run build:audio
                ↓
...
- WelcomeScene constrains player names to **6 prefab options** (per ux-elevation-2026-04-30.md T28).
...
**Cons:** contradicts ux-elevation-2026-04-30.md §4's commitment to Quest modeling thinking with words ("Hmm. I can split this in two.").
...
1. Final voice instruction string — locked when the persona bible (ux-elevation-2026-04-30.md §4) is approved.
