...
| `game-design-k2` | Create visually cohesive, pedagogically sound game interfaces for Questerix Fractions. Use when adding UI components, interactive questions, or visual systems. Prioritize clarity, accessibility, and engaging aesthetics for young learners. |
